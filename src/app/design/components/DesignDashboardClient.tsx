                          ...
                          <td className="py-3.5 px-4">
                            <div className="space-y-1">
                              <div className="flex items-center gap-1.5 flex-wrap">
                                <span className="px-2.5 py-1 rounded-lg bg-[#3A3564] text-white font-mono font-extrabold text-xs tracking-wider shadow-2xs">
                                  ART NO: {row.artNumber}
                                </span>
                              </div>
                              <span className="text-[11px] font-mono text-slate-500 font-medium block">
                                Design #{row.conceptNumber} &bull; <span className="text-slate-400">Brief #{brief.id.substring(0, 6)}</span>
                              </span>
                            </div>
                          </td>
                  ...
                  return (
                    <div key={`${brief.id}-${req.concept_number}`} className="p-4 space-y-3">
                      <div className="flex items-start justify-between gap-2">
                        <div>
                          <span className="px-2.5 py-0.5 rounded-md bg-[#3A3564] text-white font-mono font-bold text-xs tracking-wider inline-block mb-1">
                            ART NO: {artNo}
                          </span>
                          ...
                          <p className="text-xs text-slate-500 font-medium">
                            {cat} Style &bull; <span className="font-mono text-[11px] text-slate-400">Design #{req.concept_number}</span>
                          </p>
                        </div>
                      ...
                      >
                        <Eye className="w-3.5 h-3.5" />
                        <span>View &amp; Review (Art #{artNo})</span>
