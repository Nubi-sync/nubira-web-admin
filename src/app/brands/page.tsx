      ...
      <div className="p-4 sm:p-6 md:p-8 space-y-5 sm:space-y-6 max-w-7xl w-full mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white p-5 rounded-2xl border border-black/10 shadow-2xs">
            ...
            <div className="text-2xl sm:text-3xl font-black font-mono text-slate-900">100% On-Schedule</div>
          ...
          <div className="bg-white p-5 rounded-2xl border border-black/10 shadow-2xs">
            ...
            <div className="text-2xl sm:text-3xl font-black font-mono text-slate-900">Passed</div>
          ...
          <div className="bg-white p-5 rounded-2xl border border-black/10 shadow-2xs">
            ...
            <div className="text-2xl sm:text-3xl font-black font-mono text-slate-900">Active Articles</div>
            <p className="text-xs font-semibold text-slate-500 mt-1">Connected to cutting room</p>
          </div>
        </div>
