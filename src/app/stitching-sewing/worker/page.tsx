...
export const metadata = {
  title: 'Tailor Workstation | Stitching & Sewing Floor',
  description: 'Operator workstation for assigned sewing tasks, bundle assembly, and completed unit submissions.'
}

export default async function StitchingWorkerPage({
  searchParams
}: {
  ...
  if (params?.tab === 'history') {
    redirect('/stitching-sewing/worker/history')
  }
  if (params?.tab === 'profile') {
    redirect('/stitching-sewing/worker/profile')
  }
  ...
  if (!displayName || displayName === 'Floor Operator' || displayName === 'Tailor Operator' || displayName === 'Tailor') {
