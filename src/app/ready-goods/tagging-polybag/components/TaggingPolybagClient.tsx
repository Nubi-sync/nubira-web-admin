          ...
          <table className="w-full min-w-[760px] text-left text-xs border-collapse">
            <thead>
              <tr className="border-b border-black/10 bg-[#FAF7F0]/60 text-slate-600 font-mono text-[11px] uppercase tracking-wider">
                ...
                <th className="py-3.5 px-4">Physical Checks</th>
                <th className="py-3.5 px-4">Scan Match Status</th>
                ...
                <tr>
                  <td colSpan={9} className="p-0">
                    <EmptyState
                      variant="seamless"
                      icon={Tag}
                      title="No hangtag scans recorded"
                      description="Buyer EAN-13/UPC barcode scans, Kimble micro-tach verifications, and polybagging checks will appear once scanned."
                      actionLabel="Scan Garment Hangtag"
