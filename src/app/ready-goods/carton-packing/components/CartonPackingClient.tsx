          ...
          <table className="w-full min-w-[760px] text-left text-xs border-collapse">
            <thead>
              <tr className="border-b border-black/10 bg-[#FAF7F0]/60 text-slate-600 font-mono text-[11px] uppercase tracking-wider">
                ...
                <th className="py-3.5 px-4">Bundle Linkages</th>
                <th className="py-3.5 px-4">Measured vs BOM Wt</th>
                ...
                <tr>
                  <td colSpan={10} className="p-0">
                    <EmptyState
                      variant="seamless"
                      icon={PackageCheck}
                      title="No master cartons packed"
                      description="Conveyor-sealed master cartons with GS1-128 barcodes, size ratio breakdowns, and linked cutting bundles will appear once registered."
                      actionLabel="Seal & Register Carton (Form 2)"
