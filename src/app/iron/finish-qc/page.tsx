...
import { FinishQcClient } from './components/FinishQcClient'

export const dynamic = 'force-dynamic'

export default async function FinishQcPage() {
      ...
      <div className="p-4 sm:p-6 md:p-8 space-y-6 max-w-7xl w-full mx-auto">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <span className="text-[11px] font-mono font-bold uppercase tracking-wider px-2.5 py-0.5 rounded-full bg-[#FAF7F0] text-[#3A3564] border border-black/10">
            ISO 105-X11 Standard • Zero Glaze
          </span>
        </div>
            ...
            <div>
              <div className="flex items-center gap-2.5 flex-wrap">
                <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-slate-900">
                  Inline Finish & Glaze QC Station
                </h1>
              ...
              <p className="text-xs sm:text-sm font-semibold text-slate-600 mt-1">
                Spot-checking under high-intensity shadowless lamps for heat glaze, shine marks, water spots, and placket symmetry
              </p>
            </div>
          </div>
        </div>
