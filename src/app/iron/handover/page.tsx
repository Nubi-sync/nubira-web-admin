...
import { PackingHandoverClient } from './components/PackingHandoverClient'

export const dynamic = 'force-dynamic'

export default async function PackingHandoverPage() {
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm font-semibold text-slate-600 mt-1">
                Digital transfer manifests grouping verified wrinkle-free, zero-shine garments onto trolleys destined for 09 Ready Goods
              </p>
            </div>
          </div>
        </div>

        {/* Packing Handover Client */}
        <PackingHandoverClient />
