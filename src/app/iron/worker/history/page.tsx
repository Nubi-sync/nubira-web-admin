...
export const metadata = {
  title: 'Completed History | Steam Ironing Workstation',
  description: 'Verified steam ironing task archive and completed garment batches sign-offs.'
}

export default async function IronWorkerHistoryPage() {
