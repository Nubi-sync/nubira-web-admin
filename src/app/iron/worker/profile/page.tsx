...
import { fetchIronWorkersAction, fetchIronTaskAllocationsAction } from '../../actions'

export const dynamic = 'force-dynamic'

export const metadata = {
  title: 'Operator Profile | Steam Ironing Workstation',
  description: 'Iron presser credentials, badge details, and workstation roles.'
}

export default async function IronWorkerProfilePage() {
