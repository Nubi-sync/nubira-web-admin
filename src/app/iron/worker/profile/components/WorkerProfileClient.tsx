  ...
  return (
    <div className="space-y-5 sm:space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-3xl border border-black/10 shadow-2xs space-y-4">
          ...
          <div className="space-y-3 font-mono text-xs">
            <div className="flex items-center justify-between p-3 rounded-xl bg-[#FAF7F0]/60 border border-black/5">
              ...
              <span className="font-bold text-slate-900">{userName || 'Iron Presser'}</span>
            </div>
        ...
        <div className="bg-white p-6 rounded-3xl border border-black/10 shadow-2xs space-y-4">
          <div className="flex items-center gap-2.5 text-[#3A3564] font-bold text-sm">
            <Wind className="w-4.5 h-4.5 text-[#3A3564]" />
            <span>Assigned Floor Roles</span>
          </div>

          <p className="text-xs text-slate-500 font-mono">
            Operational roles assigned to this presser by the Ironing Master &amp; Floor Supervisor
          </p>
          ...
          <div className="p-3.5 rounded-xl bg-slate-50 border border-black/5 text-xs text-slate-600 font-mono space-y-1 mt-4">
            ...
            <div>• Receive article garment pressing piece quotas &amp; vacuum buck tables</div>
            <div>• Control steam temperature presets &amp; verify teflon shoe</div>
            <div>• Submit finished pressed batches to Head of Dept for verification</div>
          </div>
        </div>
