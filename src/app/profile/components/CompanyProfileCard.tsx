    ...
    <>
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
                Primary Garment Manufacturing & Apparel Production Unit
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4.5 pt-5">
          ...
          <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50/70 border border-slate-100">
            ...
            <div className="min-w-0 flex-1">
              ...
              <span className="text-xs sm:text-sm font-semibold text-slate-800 break-words mt-0.5 block leading-snug">
                {factoryAddress}
              </span>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50/70 border border-slate-100">
            ...
            <div className="min-w-0 flex-1">
              ...
              <span className="text-xs sm:text-sm font-mono font-bold text-slate-800 mt-0.5 block">
                {gstin}
              </span>
            </div>
          </div>
      ...
      {isEditing && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-xs animate-in fade-in duration-200">
          <div 
            className="bg-white rounded-2xl max-w-lg w-full p-6 shadow-2xl border border-slate-200 animate-in zoom-in-95 duration-200"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex items-center justify-between pb-4 border-b border-slate-100">
              <div className="flex items-center gap-2.5">
                <div className="w-9 h-9 rounded-lg bg-[#FAF7F0] text-[#3A3564] border border-black/10 flex items-center justify-center">
                  <Building2 className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="text-lg font-bold text-slate-900">Edit Company Information</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 pt-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3.5 py-2 rounded-xl text-sm border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#3A3564]/20 focus:border-[#3A3564] transition-all resize-none"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                <div>
                  ...
                  <input
                    ...
                    name="gstin"
                    defaultValue={gstin}
                    className="w-full px-3.5 py-2 rounded-xl text-sm font-mono border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#3A3564]/20 focus:border-[#3A3564] transition-all"
