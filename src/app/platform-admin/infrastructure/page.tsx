          ...
          <div className="bg-white p-5 sm:p-6 rounded-2xl border border-black/10 shadow-2xs space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3 font-mono text-xs">
              <div className="p-3.5 rounded-xl bg-[#FAF7F0] border border-black/10">
                <span className="text-[11px] text-slate-500 block font-[family-name:var(--font-public-sans)]">Cutting Lays</span>
                <span className="text-xl font-bold text-slate-900 mt-1 block">1,248</span>
              </div>
              <div className="p-3.5 rounded-xl bg-[#FAF7F0] border border-black/10">
                <span className="text-[11px] text-slate-500 block font-[family-name:var(--font-public-sans)]">Fabric Rolls</span>
                <span className="text-xl font-bold text-slate-900 mt-1 block">4,890</span>
              </div>
              <div className="p-3.5 rounded-xl bg-[#FAF7F0] border border-black/10">
                <span className="text-[11px] text-slate-500 block font-[family-name:var(--font-public-sans)]">Bundle Barcodes</span>
                <span className="text-xl font-bold text-slate-900 mt-1 block">82,400</span>
              </div>
              <div className="p-3.5 rounded-xl bg-[#FAF7F0] border border-black/10">
                <span className="text-[11px] text-slate-500 block font-[family-name:var(--font-public-sans)]">Operator Wages</span>
                <span className="text-xl font-bold text-slate-900 mt-1 block">14,290</span>
              </div>
              <div className="p-3.5 rounded-xl bg-[#FAF7F0] border border-black/10">
                <span className="text-[11px] text-slate-500 block font-[family-name:var(--font-public-sans)]">Export Cartons</span>
                <span className="text-xl font-bold text-slate-900 mt-1 block">22,100</span>
              </div>
              <div className="p-3.5 rounded-xl bg-[#FAF7F0] border border-black/10">
                <span className="text-[11px] text-slate-500 block font-[family-name:var(--font-public-sans)]">Rework Tickets</span>
                <span className="text-xl font-bold text-slate-900 mt-1 block">3,120</span>
              </div>
            </div>
          </div>
