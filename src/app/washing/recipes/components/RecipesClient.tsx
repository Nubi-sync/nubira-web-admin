...
import { WashRecipe } from '../../types/washing'
        ...
        {filtered.length > 0 ? (
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div>
                  ...
                  <h3 className="text-base font-black text-slate-900 mt-1.5 font-[family-name:var(--font-heading)]">{r.recipeName}</h3>
              ...
              <div className="bg-[#FAF7F0]/60 p-3.5 rounded-xl border border-black/10 space-y-2">
                ...
                <div className="grid grid-cols-3 gap-2 pt-1 text-xs font-mono">
                  ...
                  <div className="bg-white p-2 rounded-lg border border-black/5">
                    ...
                    <span className="font-bold text-slate-900">{r.aceticAcidGpl} g/L</span>
                  ...
                  <div className="bg-white p-2 rounded-lg border border-black/5">
                    ...
                    <span className="font-bold text-slate-900">{r.softenerGpl} g/L</span>
          ...
          <div className="col-span-full">
            <EmptyState
              variant="seamless"
              icon={FlaskConical}
              title="No wash recipes found"
              description="Bio-enzyme polishing, silicon softening, and chemical liquor formulations will appear once registered."
