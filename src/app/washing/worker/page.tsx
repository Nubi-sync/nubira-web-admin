...
export const metadata = {
  title: 'Worker Portal | Washing Floor',
  description: 'Floor operator workstation for assigned washing batches, hydro-extraction runs, and completion sign-offs.'
}

export default async function WashingWorkerPage({
  searchParams
}: {
  ...
  if (params?.tab === 'history') {
    redirect('/washing/worker/history')
  }
  if (params?.tab === 'profile') {
    redirect('/washing/worker/profile')
  }
  ...
  if (!displayName || displayName === 'Floor Operator' || displayName === 'Washer Operator' || displayName === 'Washing Floor Operator') {
    const metaName = user.user_metadata?.full_name
    if (metaName && metaName !== 'Floor Operator' && metaName !== 'Washer Operator' && metaName !== 'Washing Floor Operator') {
