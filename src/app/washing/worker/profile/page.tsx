...
import { fetchWashingWorkersAction, fetchWashingTaskAllocationsAction } from '../../actions'

export const dynamic = 'force-dynamic'

export const metadata = {
  title: 'Operator Profile | Industrial Washing Workstation',
  description: 'Washing floor operator credentials, badge details, and washing workstation roles.'
}

export default async function WashingWorkerProfilePage() {
