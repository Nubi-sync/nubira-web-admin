...
export const metadata = {
  title: 'Operator Profile | Printing Studio Workstation',
  description: 'Printing floor operator credentials, badge details, and workstation roles.'
}

export default async function PrintingWorkerProfilePage() {
