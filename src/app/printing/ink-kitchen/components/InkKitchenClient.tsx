...
import { InkRecipe } from '../../types/printing'
import { getInkRecipes, PRINTING_UPDATE_EVENT } from '../../utils/printingStorage'
    ...
    <div className="p-4 sm:p-6 md:p-8 space-y-5 sm:space-y-6 max-w-7xl w-full mx-auto text-[#09090b] select-none">
      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div className="flex items-center gap-2 text-xs font-medium text-slate-400">
          ...
          <span className="font-mono font-bold text-slate-900 text-xs">Ink Kitchen & Recipes</span>
        </div>
                ...
                <tr>
                  <td colSpan={7} className="p-0">
                    <EmptyState
                      variant="seamless"
                      icon={Palette}
                      title="No ink formulation recipes recorded"
                      description="Grams breakdown, shear-thinning viscosity (cps), and eco-passport records will render once formulated."
                      actionLabel="Formulate New Recipe"
