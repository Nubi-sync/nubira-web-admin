        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-600 mt-1 font-mono">
              Floor ID: {workerRecord?.id || userId ? `OP-${(workerRecord?.id || userId).slice(-6)}` : 'OP-CUT-01'} • Nubira Creation Floor
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-3xl border border-black/10 shadow-2xs space-y-4">
          ...
          <div className="space-y-3 font-mono text-xs">
            <div className="flex items-center justify-between p-3 rounded-xl bg-[#FAF7F0]/60 border border-black/5">
              ...
              <span className="font-bold text-slate-900">{userName || 'Cutting Operator'}</span>
            </div>
        ...
        <div className="bg-white p-6 rounded-3xl border border-black/10 shadow-2xs space-y-4">
          ...
          <p className="text-xs text-slate-500 font-mono">
            Operational roles assigned to this operator by the Cutting Master &amp; Floor Supervisor
          </p>
          ...
          <div className="p-3.5 rounded-xl bg-slate-50 border border-black/5 text-xs text-slate-600 font-mono space-y-1 mt-4">
            ...
            <div>• Receive article cutting piece quotas &amp; vacuum tables</div>
            <div>• Start live cutting clock and record table operations</div>
