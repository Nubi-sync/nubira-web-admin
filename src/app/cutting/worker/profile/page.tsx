...
import { fetchCuttingWorkersAction, fetchCuttingTaskAllocationsAction } from '../../actions'

export const dynamic = 'force-dynamic'

export const metadata = {
  title: 'Operator Profile | Cutting Floor Workstation',
  description: 'Cutting floor operator credentials, badge details, and workstation roles.'
}

export default async function CuttingWorkerProfilePage() {
