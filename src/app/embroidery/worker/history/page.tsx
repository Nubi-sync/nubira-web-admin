...
export const metadata = {
  title: 'Completed History | Embroidery Studio Workstation',
  description: 'Verified embroidery task archive and completed garment pieces sign-offs.'
}

export default async function EmbroideryWorkerHistoryPage() {
